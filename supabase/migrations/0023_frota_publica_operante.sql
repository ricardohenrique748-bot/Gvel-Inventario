-- Gvel Diesel — adiciona a situação operante/inoperante no retorno da função
-- pública `get_frota_publica`, pra permitir filtrar a listagem por situação
-- no link público de acompanhamento de frota. Precisa dropar antes pois muda
